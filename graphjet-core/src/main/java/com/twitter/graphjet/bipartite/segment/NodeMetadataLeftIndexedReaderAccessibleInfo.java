 ...
 */
public class NodeMetadataLeftIndexedReaderAccessibleInfo extends LeftIndexedReaderAccessibleInfo {
  private final List<IntToIntArrayMap> rightNodesToMetadataMap;
   ...
   * @param rightNodesToMetadataMap contains metadata of right nodes
   */
  public NodeMetadataLeftIndexedReaderAccessibleInfo(
    ...
    this.rightNodesToMetadataMap = rightNodesToMetadataMap;
  }

  public List<IntToIntArrayMap> getRightNodesToMetadataMap() {
    return rightNodesToMetadataMap;
  }

  public IntToIntArrayMap getRightNodesToMetadataMap(int nodeMetadataType) {
    return rightNodesToMetadataMap.get(nodeMetadataType);
  }
}
